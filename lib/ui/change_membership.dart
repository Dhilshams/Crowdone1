...
class ChangeMembership extends StatefulWidget {

  String membershiptype;

   ChangeMembership(this.membershiptype) ;

  @override
  _ChangeMembershipState createState() => _ChangeMembershipState(this.membershiptype);
}

class _ChangeMembershipState extends State<ChangeMembership> {

  String membershiptype;
  _ChangeMembershipState(this.membershiptype);
  ...
  getSalesOffersList() async {
    ...
    for (int i = 0; i < c.length; i++) {
      ...
      setState(() {
        ...
        if(membershiptype.trim().compareTo(name)!=0 && name.compareTo("Customer Membership")!=0) {
          salesoffer.add(data);
        }
      });
    }
