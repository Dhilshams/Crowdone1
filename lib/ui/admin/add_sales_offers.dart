...
class AddSalesOffers extends StatefulWidget {
  int code;
  SalesOffer sl;


   AddSalesOffers(this.code,this.sl) ;

  @override
  _AddSalesOffersState createState() => _AddSalesOffersState(this.code,this.sl);
}

class _AddSalesOffersState extends State<AddSalesOffers> {
  ...
  _AddSalesOffersState(this.code,this.sl);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      appBar: AppBar(
        ...
        title: Text(
          (code==0)? "Add Sales Offers" : "Update Sales Offers",
                        ...
                        if(filepath.isNotEmpty)
                          {
                            if(nameController.text.isNotEmpty)
                            {
                              ...
                              final ref = FirebaseStorage.instance.ref().child('salesofferimages').child('${DateTime.now()}.jpg');
                              ...
                              if(code==1)
                                {
                                  final productRef = FirebaseFirestore.instance
                                      .collection('salesoffer').doc(sl.id);
                                  await productRef.update({
                                    ...
                                    //   const SnackBar(content: Text('Sales offer updated successfully')),
                                    // );

                                    ResponsiveInfo.showAlertDialog(context, "", "Sales offer updated successfully");
                                ...
                                await productRef.set({
                                  ...
                                  Navigator.pop(context);
                                  // ScaffoldMessenger.of(context).showSnackBar(
                                  //   const SnackBar(content: Text('Sales offer added successfully')),
                                  // );

                                  ResponsiveInfo.showAlertDialog(context, "", "Sales offer added successfully");
