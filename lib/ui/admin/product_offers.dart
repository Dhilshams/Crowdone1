...
import 'package:ecommerce/ui/admin/add_product_offers.dart';

class ProductOffers extends StatefulWidget {
   ProductOffers() ;

  @override
  _ProductOffersState createState() => _ProductOffersState();
}
                  ...
                  onTap: () async{
                    ...
                    await Navigator.of(context).push(new MaterialPageRoute<dynamic>(
                      builder: (BuildContext context) {
                        return new AddProductOffers(0,new SalesOffer("","",""));
                      },
                    ));
                            ...
                            Expanded(child: ListTile(
                                ...
                                trailing: TextButton(
                                  ...
                                  onPressed: ()async{
                                    ...
                                    await Navigator.of(context).push(new MaterialPageRoute<dynamic>(
                                      builder: (BuildContext context) {
                                        return new AddProductOffers(1,salesoffer[index]);
                                      },
                                    ));
